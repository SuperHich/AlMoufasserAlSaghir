...
import com.almoufasseralsaghir.entity.ReminderListItem;
			...
			reminder_confirm.setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_UP: {
						...
						if (isOK)
							Toast.makeText(CalendarActivity.this, R.string.reminder_ok, Toast.LENGTH_SHORT).show();
						 else 
							Toast.makeText(CalendarActivity.this, R.string.reminder_not_ok, Toast.LENGTH_SHORT).show();
